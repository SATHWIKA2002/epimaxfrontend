...
const taskDetailstList = JSON.parse(localStorage.getItem('taskDetails'));

class AssignTaskPage extends Component {
    state = {tasksList: taskDetailstList}
    ...
    render() {
        ...
        return(
            <div className='assigned-task-bg'>
                ...
                <h1 className="assigned-page-heading">Assigned Tasks</h1>
